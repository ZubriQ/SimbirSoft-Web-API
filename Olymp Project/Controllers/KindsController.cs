...
namespace Olymp_Project.Controllers
{
    ...
    public class KindsController : ControllerBase
    {
        ...
        [HttpGet("{kindId:long}")]
        [Authorize(AuthenticationSchemes = ApiAuthenticationScheme.Name), AllowAnonymous]
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = ApiAuthenticationScheme.Name, Roles = "ADMIN,CHIPPER")]
        ...
        [Authorize(AuthenticationSchemes = ApiAuthenticationScheme.Name, Roles = "ADMIN")]
