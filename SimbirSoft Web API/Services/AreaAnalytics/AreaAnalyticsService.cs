using SimbirSoft_Web_API.Helpers.Geospatial;
...
namespace SimbirSoft_Web_API.Services.AreaAnalytics
{
    public class AreaAnalyticsService : IAreaAnalyticsService
    {
        ...
        public async Task<IResponse<AreaAnalyticsResponseDto>> GetAnalyticsByAreaIdAsync(
        ...
        private async Task<IResponse<AreaAnalyticsResponseDto>> GetAreaAnalyticsAsync(
