...
namespace SimbirSoft_Web_API.Services.AnimalsKinds
{
    public class AnimalKindService : IAnimalKindService
    {
        ...
        public async Task<IResponse<Animal>> InsertKindToAnimalAsync(
        ...
        private async Task<IResponse<Animal>> AddKindToAnimalAndSaveChangesAsync(
        ...
        public async Task<IResponse<Animal>> UpdateAnimalKindAsync(
        ...
        private async Task<IResponse<Animal>> UpdateKindInAnimalAndSaveChangesAsync(
        ...
        public async Task<IResponse<Animal>> RemoveAnimalKindAsync(long? animalId, long? kindId)
        {
        ...
        private async Task<IResponse<Animal>> RemoveKindFromAnimalByIdsAsync(Animal animal, long kindId)
        {
            try
            {
