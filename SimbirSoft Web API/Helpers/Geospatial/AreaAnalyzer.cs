...
public class AreaAnalyzer
{
    ...
    private long _totalAnimalsArrived;
    private long _totalAnimalsGone;
    private long _totalQuantityAnimals;

    // AnimalsAnalyticsDto[] filling.
    private readonly Dictionary<long, string> _uniqueKinds;
    private readonly Dictionary<long, long> _kindCount;
    private readonly Dictionary<long, (long arrived, long gone)> _kindArrivedGone;
